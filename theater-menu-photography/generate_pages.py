...
COVER_PROMPT = (
    ...
    "front-on like a scanned printed page (not a 3D mockup, no page shadow, "
    "no tilt, no table beneath it, fills the entire frame edge-to-edge). "
    "One single continuous beautiful elegant overhead flat-lay photograph "
    "filling the ENTIRE frame: aromatic Indian spices (star anise, "
    "cinnamon sticks, cardamom pods, dried red chilies, coriander seeds, "
    "saffron threads, cloves) scattered artfully and evenly across a warm "
    "marble surface with soft directional light and gentle natural shadow, "
    "consistent lighting throughout, no seams, no repeated patterns, no "
    "harsh drop shadows or boxes. The attached reference image is the "
    "restaurant's exact logo lockup — reproduce this exact wordmark, exact "
    "letterforms, exact font, exact 'INDIAN KITCHEN & BAR' subtitle line "
    "and exact small star divider, pixel-faithful to the reference, sized "
    "to about 60% of the page width, placed in the upper third of the "
    "page, sitting naturally into the photograph with soft realistic "
    "lighting (a gentle natural shadow under the letters is fine) — do NOT "
    "put it inside a box, panel, or rectangle of any kind, do not change "
    "the font or letterforms from the reference. Beneath the subtitle, "
    "small elegant italic text: 'Duong Dong, Phu Quoc'. No other text "
