...
HERO_PROMPTS = [
    ("divider-small-plates", (
        ...
        "the entire frame edge-to-edge with NO border, no frame, no card, "
        "no inset margin, no cream padding around the photo anywhere — the "
        "photo IS the full page, corner to corner). No dish list, no prices, no arrows, no "
